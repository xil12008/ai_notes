...
This is called action-value function $Q(s_i, a_i) = \sum_{i=t}^{N} \gamma^i r_i$. It's also called "discounted" reward because a future rewards x steps away get "discounted" by a factor of $\gamma^x << 1$.
